...
def background_ai_pipeline():
    ...
    while state.running:
        ...
        if is_synthetic:
            ...
            # Top Banner
            cv2.rectangle(annotated, (10, 10), (560, 48), (15, 23, 42), -1)
            cv2.rectangle(annotated, (10, 10), (560, 48), (0, 230, 118), 2)
        ...
        for d in recognized_detections:
            ...
            if d.class_name == "person":
                ...
                color = (0, 240, 255) if is_owl else (0, 255, 100)
                tag = " [OWLv2]" if is_owl else ""

...
def test_source_isolation_demo_vs_upload_vs_webcam():
    ...
    # 1. Synthetic Demo Video (MUST remain DEMO_SIMULATION / YOLO11n untouched)
    ...
    # 2. Uploaded Video file (MUST remain REAL_EDGE_CV / YOLO11n untouched)
    detector.set_active_source("videos/uploaded_aisle.mp4")
    assert detector.mode == "REAL_EDGE_CV"
